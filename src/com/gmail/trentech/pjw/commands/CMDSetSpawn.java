...
public class CMDSetSpawn implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		if(!args.hasAny("value")) {
			...
			src.sendMessage(Texts.of(TextColors.DARK_GREEN, "Set spawn of world ", worldName, " to x: ", world.getProperties().getSpawnPosition().getX(), ", y: ", world.getProperties().getSpawnPosition().getY(), ", z: ", world.getProperties().getSpawnPosition().getZ()));
