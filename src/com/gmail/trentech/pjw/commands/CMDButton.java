...
public class CMDButton implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		if(!args.hasAny("name")) {
			src.sendMessage(Texts.of(TextColors.GOLD, "/world button <world>"));
			return CommandResult.empty();
		}
		...
		ButtonEventManager.creators.put(player, worldName);

		player.sendMessage(Texts.of(TextColors.DARK_GREEN, "Place button to create teleport button"));
