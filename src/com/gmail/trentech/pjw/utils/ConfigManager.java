		...
		if(file.getName().equalsIgnoreCase("config.conf")){
			...
			for(World world : Main.getGame().getServer().getWorlds()){
				...
				if(config.getNode("Worlds", world.getName()).getString() == null){
					...
					config.getNode("Worlds", world.getName(), "Bed-Respawn").setValue(true);
					...
					config.getNode("Worlds", world.getName(), "Keep-Spawn-Loaded").setValue(properties.doesKeepSpawnLoaded());
					config.getNode("Worlds", world.getName(), "Hardcore").setValue(properties.isHardcore());
