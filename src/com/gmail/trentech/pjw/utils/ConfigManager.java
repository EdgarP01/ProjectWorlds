...
//		else if(file.getName().equalsIgnoreCase("buttons.conf")){
//			if(config.getNode("Buttons").getString() == null) {
//				config.getNode("Buttons").setComment("DO NOT EDIT THIS FILE");
//			}
//		}else if(file.getName().equalsIgnoreCase("plates.conf")){
//			if(config.getNode("Plates").getString() == null) {
//				config.getNode("Plates").setComment("DO NOT EDIT THIS FILE");
//			}
//		}
		save();
	}
