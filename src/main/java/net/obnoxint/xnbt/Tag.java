...
/**
 * <p>
 * Classes annotated with Tag can be serialized and deserialized using a
 * {@link XNBTTag}. This annotation can be omitted on a class, if its fields
 * contain only primitive types. Fields without this annotation will be ignored.
 * </p>
 */
@Documented
...
public @interface Tag {
	...
	/**
	 * <p>
	 * Automatically determines the type of the tag by this fields type class.
	 * (best effort)
	 * </p>
	 */
	byte AUTO = (byte) 0;
	...
	/**
	 * <p>
	 * The name of the class or field. If this value is omitted, the simple name
	 * of the class or the name of the field will be used.
	 * </p>
	 * 
	 * @return the name
	 */
