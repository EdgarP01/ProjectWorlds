...
public enum Rotation {
	...
	SOUTH_EAST("southeast", -45), EAST("east", -90), NORTH_EAST("northeast", -135), NORTH("north", -180), NORTH_WEST("northwest", -225), WEST("west", -270), SOUTH_WEST("southwest", -315), SOUTH("south", -360);
