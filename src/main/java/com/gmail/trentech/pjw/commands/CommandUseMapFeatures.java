...
public class CommandUseMapFeatures implements CommandCallable {
	
	private final Help help = Help.get("world usemapfeatures").get();
	...
	public CommandResult process(CommandSource source, String arguments) throws CommandException {
		...
		world.setMapFeaturesEnabled(Boolean.valueOf(args.get(1)));
		
		Sponge.getServer().saveWorldProperties(world);
		
		source.sendMessage(Text.of(TextColors.DARK_GREEN, "Set use map features of ", world.getWorldName(), " to ", TextColors.YELLOW, args.get(1)));
	...
	public boolean testPermission(CommandSource source) {
		Optional<String> permission = help.getPermission();
	...
	public Optional<Text> getShortDescription(CommandSource source) {
		return Optional.of(Text.of(help.getDescription()));
	}
