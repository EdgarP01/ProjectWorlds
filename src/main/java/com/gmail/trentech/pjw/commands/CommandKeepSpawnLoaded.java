...
public class CommandKeepSpawnLoaded implements CommandCallable {
	...
	public CommandResult process(CommandSource source, String arguments) throws CommandException {
		...
		world.setKeepSpawnLoaded(Boolean.valueOf(args.get(1)));

		Sponge.getServer().saveWorldProperties(world);
		
		source.sendMessage(Text.of(TextColors.DARK_GREEN, "Set keep spawn loaded of ", world.getWorldName(), " to ", TextColors.YELLOW, args.get(1)));
