...
public class CommandPvp implements CommandCallable {
	
	private final Help help = Help.get("world pvp").get();
	...
	public CommandResult process(CommandSource source, String arguments) throws CommandException {
		...
		world.setPVPEnabled(Boolean.valueOf(args.get(1)));
		
		Sponge.getServer().saveWorldProperties(world);
		
		source.sendMessage(Text.of(TextColors.DARK_GREEN, "Set pvp of ", world.getWorldName(), " to ", TextColors.YELLOW, args.get(1)));
